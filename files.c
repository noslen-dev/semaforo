...
/****
 * static void write_node_info_to_file(no da lista, ficheiro de texto para escrita)
 ...
 *  numero de colunas do tabuleiro, ficheiro de texto para escrita)
...
/***
 * bool export_states_txt(cabeca da lista que contem os estados do tabuleiro, modo de jogo)
 ...
 * Devolve 1 se conseguiu criar o ficheiro e escrever nele.
